...
/// <summary>
/// Snapshot inmutable del contexto activo de un desk, tal como lo consume la UI (barra, overlay,
...
/// <summary>
/// Los colores con los que se identifican los contextos de un espacio.
///
/// Por qué existe: el problema que originó los contextos NO era no poder anotarlos, era ERRARLE al
/// contexto al cambiar de pantalla. El texto obliga a LEER; el color se percibe de reflejo, con la
/// visión periférica. Por eso cada contexto arranca ya con un color asignado — cero fricción, la
...
/// un contexto NUNCA se debe confundir con un tipo de desk.
/// </summary>
public static class ModulePalette
{
    /// <summary>Colores disponibles, en el orden en que se auto-asignan a los contextos nuevos.</summary>
    ...
    /// <summary>Fallback: el dorado de DESK +N. Un contexto sin color se ve como se veía antes.</summary>
    ...
    /// <summary>
    /// Primer color de la paleta que NINGÚN contexto del espacio esté usando ya — así dos contextos
